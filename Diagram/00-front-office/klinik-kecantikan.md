# Front Office Flowchart - Klinik Kecantikan
...
flowchart TD
    ...
    subgraph A_Pendaftaran_Langsung["A. PENDAFTARAN LANGSUNG (Walk-In)"]
        ...
        A6b --> A7{"Member atau Bukan?"}
        A7 -->|Ya| A8["Validasi Member"]
        A7 -->|Tidak| A9["Registrasi Pasien Baru"]
        
        A8 --> A8a["Buat Kunjungan Baru"]
        A8a --> A10["Input Keluhan"]
        A10 --> A17["Masuk Antrian Dokter"]
        
        A9 --> A9a["Scan/Foto KTP"]
        A9a --> A9b["Auto-Fill: Nama, Alamat, NIK, Tgl Lahir"]
        A9b --> A9c["Lengkapi Data (Pekerjaan, Telepon)"]
        A9c --> A12["Registrasi Pasien Baru"]
    ...
    subgraph B_Booking_Online["B. BOOKING ONLINE"]
        ...
        B4 --> B5{"Member atau Bukan?"}
        
        B5 -->|Ya| B6["Validasi Member"]
    ...
    subgraph D_Ruang_Dokter["D. RUANG DOKTER"]
        D1["Konsultasi (WAJIB)"] --> D1a["Input SOAP"]
        D1a --> D1b["Foto Before"]
        D1b --> D1c["Marking Anatomi Wajah"]
        D1c -.->|"📍 Titik injeksi<br/>📍 Lokasi jerawat<br/>📍 Lokasi scar"| FaceMapping
        D1c --> D1d["Treatment/Action"]
        D1d --> D1e["Foto After"]
        D1e --> D2{"Resep Obat?"}
    ...
    subgraph FaceMapping["📍 Marking Anatomi Wajah"]
        FM1["🗺️ Gambar anatomi wajah<br/>Dokter menandai:<br/>• Titik yang diinjeksi<br/>• Lokasi jerawat<br/>• Lokasi scar<br/>• Area treatment lain"]
    end
    ...
    style FaceMapping fill:#FFF9C4,stroke:#FBC02D
```
